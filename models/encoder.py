...
class Res101Encoder(nn.Module):
    ...
    def __init__(self, replace_stride_with_dilation=None, pretrained_weights='deeplabv3'):
        super().__init__()
        self.pretrained_weights = torch.load(
            "/data1/jiangzhen/sjl/qnet/deeplabv3_resnet101_coco-586e9e4e.pth", map_location='cpu')
