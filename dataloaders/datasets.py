...
# 处理医学影像分割任务中的训练和测试数据
# 从特定的数据集（CMR、CHAOST2和SABS）加载医学图像和标签，并执行一些数据预处理和增强操作
...
class TestDataset(Dataset):
    ...
    def __init__(self, args):
        ...
        self.label = None
        # print(f'All image directories: {self.image_dirs}')
        # print(f'Fold {args["eval_fold"]} directories: {self.FOLD[args["eval_fold"]]}')
